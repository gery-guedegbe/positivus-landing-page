      ...
      >
        {successStories.map((story, index) => {
          return (
            <div
              key={story.id}
              className={`${index == 1 ? "border-0 lg:border-x-[1px]" : ""} ${index == 4 ? "border-0 lg:border-x-[1px]" : ""} ${index >= 3 ? "border-0 lg:border-t-[1px]" : ""} flex flex-col items-start gap-3 rounded-3xl border-[1px] border-black p-4 shadow-[0px_4px_0px_0px_#000] md:gap-4 lg:rounded-none lg:border-0 lg:p-6 lg:shadow-none`}
            >
